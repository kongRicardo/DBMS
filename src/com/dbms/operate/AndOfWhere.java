...
public class AndOfWhere {
	...
	public AndOfWhere(String table, List<DBFField> fieldsOfTable) {
		flags = new int[10];
	...
	public boolean judgeAnd(Map<String, Object> record) throws MyException {// 对Student.Sno这种模式还未处理
		switch (type) {
		case BETWEEN:
			try {
